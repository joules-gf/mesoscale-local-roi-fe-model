...
INPUT_FILE = INPUT_FOLDER / 'original.xml'
...
def make_aa2024_plots(case_dir, result_csv):
    ...
    ax.set_title('Original AA2024-T351 Simulation vs Reference')
    ax.grid(True)
    ax.legend()
    fig.tight_layout()
    ...
    ax.set_title("Simulation 'original' Displacement vs Step Time")
    ax.grid(True)
    fig.tight_layout()
...
def main():
    ...
    print('ORIGINAL AA2024 FULL CYCLE START', flush=True)
    ...
    print('ORIGINAL AA2024 FULL CYCLE COMPLETE', flush=True)
